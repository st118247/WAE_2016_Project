...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { author_name: @quotation.author_name, category: @quotation.category, quote: @quotation.quote } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { author_name: @quotation.author_name, category: @quotation.category, quote: @quotation.quote } }
